...
const MOCK_RECIPES = [
  ...
  {
    id: 16, name: '香煎牛排配红酒汁',
    emoji: '🥩', heroColor: '#E8D0C0',
    time: '30分钟', difficulty: '困难', diffLevel: 2, calories: '约480千卡',
    taste: ['国菜'], method: '煎',
    ingredients: ['西冷牛排 200g', '黄油', '迷迭香', '大蒜', '红酒 100ml', '牛肉高汤', '黑胡椒', '海盐'],
    steps: [
      { text: '牛排提前30分钟取出回温，用厨房纸吸干表面水分，两面撒海盐和黑胡椒。', emoji: '🥩' },
      { text: '铸铁锅大火烧至冒烟，加少许油，放入牛排，每面煎90秒至焦褐色。', emoji: '🔥' },
      { text: '转中小火，加入黄油、蒜瓣和迷迭香，用勺不断将融化的黄油淋在牛排上（Basting技法）。', emoji: '🧈' },
      { text: '牛排取出静置5分钟。锅中倒入红酒大火收汁至一半，加牛肉高汤浓缩成红酒酱汁，淋在牛排上即可。', emoji: '🍷' }
    ],
    protein: '38g', carbs: '3g', fat: '34g', tags: ['米其林', '西餐', '硬菜']
  },
  {
    id: 17, name: '法式红酒炖鸡',
    emoji: '🍲', heroColor: '#C08070',
    time: '90分钟', difficulty: '困难', diffLevel: 2, calories: '约520千卡',
    taste: ['国菜'], method: '煮',
    ingredients: ['整鸡 1只', '红酒 1瓶', '培根', '蘑菇', '珍珠洋葱', '胡萝卜', '百里香', '香叶', '面粉', '黄油'],
    steps: [
      { text: '整鸡切大块，盐和胡椒腌制。培根切条煎至酥脆盛出，鸡块煎至金黄盛出。', emoji: '🔪' },
      { text: '同一锅中炒香蘑菇、珍珠洋葱和胡萝卜块。', emoji: '🍳' },
      { text: '撒入面粉翻炒均匀出香味，倒入整瓶红酒和鸡高汤，加百里香和香叶。', emoji: '🍷' },
      { text: '放回鸡块和培根，烤箱160°C慢炖1.5小时至肉酥烂，最后加一小块黄油提亮收汁。', emoji: '✨' }
    ],
    protein: '42g', carbs: '8g', fat: '30g', tags: ['米其林', '法餐', '宴客']
  },
  {
    id: 18, name: '惠灵顿牛排',
    emoji: '🥩', heroColor: '#D4A060',
    time: '120分钟', difficulty: '困难', diffLevel: 2, calories: '约650千卡',
    taste: ['国菜'], method: '蒸',
    ingredients: ['菲力牛排 500g', '酥皮', '蘑菇', '帕尔马火腿', '鹅肝（可选）', '芥末酱', '鸡蛋', '黄油', '百里香'],
    steps: [
      { text: '菲力牛排用盐胡椒腌制，大火煎至表面焦褐色出壳，趁热刷芥末酱，静置冷却。', emoji: '🥩' },
      { text: '蘑菇切碎末，干锅炒至水分完全蒸发成菌菇泥（Duxelles），冷却备用。', emoji: '🍄' },
      { text: '保鲜膜上铺帕尔马火腿、菌菇泥，放上牛排，卷紧实成圆柱形，冷藏定型30分钟。', emoji: '🌀' },
      { text: '酥皮包裹牛排卷，刷蛋液封口，表面刻花纹，再刷一层蛋液。烤箱200°C烤25分钟至酥皮金黄，静置10分钟后切片。', emoji: '✨' }
    ],
    protein: '45g', carbs: '25g', fat: '40g', tags: ['米其林', '地狱厨房', '宴客']
  },
  {
    id: 19, name: '蒜香海鲜意面',
    emoji: '🍝', heroColor: '#FFF0D8',
    time: '35分钟', difficulty: '中等', diffLevel: 1, calories: '约420千卡',
    taste: ['日式'], method: '煮',
    ingredients: ['意大利面 200g', '大虾 6只', '鱿鱼圈', '蛤蜊', '大蒜 6瓣', '干辣椒', '白葡萄酒', '橄榄油', '欧芹', '柠檬'],
    steps: [
      { text: '大虾去壳去虾线，鱿鱼切圈，蛤蜊吐沙洗净。大蒜切薄片，干辣椒剪段。', emoji: '🔪' },
      { text: '大锅盐水煮意面至al dente（比包装少1分钟），捞出保留一杯面汤。', emoji: '🍲' },
      { text: '冷锅倒入大量橄榄油，小火煸香蒜片和干辣椒至蒜片金黄。', emoji: '🧄' },
      { text: '转大火，先下虾和鱿鱼翻炒1分钟，加蛤蜊和白葡萄酒盖盖焖至蛤蜊开口。加入意面翻拌，分次加面汤调节浓稠度，撒欧芹碎和柠檬汁出锅。', emoji: '✨' }
    ],
    protein: '28g', carbs: '45g', fat: '16g', tags: ['海鲜', '意面', '宴客']
  }
];
